						...
						<ul class="nav navbar-nav">
							...
							<li id="3" class="dropdown">
								...
								<ul class="dropdown-menu">
									<li id="31"><a href="inputpesanan.php">Input Pesanan</a></li>
									<li id="32"><a href="inputobat.php">Input Obat Baru</a></li>
									<li role="separator" class="divider"></li>
									<li class="dropdown-header">Transaksi Harian</li>
									<li id="33"><a href="daftarpesanan.php">Semua Pesanan</a></li>
									<li id="34"><a href="pembayaran.php">Pembayaran</a></li>
									<li id="35"><a href="pengiriman.php">Pengiriman</a></li>
									<!-- <li role="separator" class="divider"></li>
